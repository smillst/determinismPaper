...
\begin{figure}
    ...
    $\infer[\sc{ORDERNONDET \ COLLECTION}]{\vdash : \kappa_c \  \beta_c \langle\kappa_e \ \beta_e\rangle}{\kappa_c : \mathit{OrderNonDet/Det} & \kappa_e \sqsubseteq \kappa_c & \beta_c \sqsubseteq \mathit{Collection/Map/Iterator}}$
    
    \bigskip
    
    $\infer[\sc{ORDERNONDET \ ARRAY}]{\vdash : \kappa_e \ \beta_e \ \  \kappa_a []}{\kappa_a : \mathit{OrderNonDet/Det} & \kappa_e \sqsubseteq \kappa_a }$
    
    \bigskip
    
    $\infer[\sc{NONDET \ COLLECTION}]{\vdash : \kappa_c \ \beta_c\langle\kappa_e \ \beta_e\rangle}{\kappa_c : \mathit{NonDet} & \kappa_e : \mathit{NonDet} & \beta_c \sqsubseteq \mathit{Collection/Map/Iterator}}$
    
    \bigskip
    
    $\infer[\sc{NONDET \ ARRAY}]{\vdash : \kappa_e \ \beta_e \ \  \kappa_a []}{\kappa_a : \mathit{NonDet} & \kappa_e : \mathit{NonDet} }$
