...
$\infer{\Gamma \vdash x : \tau_2}{\Gamma \vdash x : \tau_1 & \tau_1 \sqsubseteq \tau_2}$

Typing rule for method calls:
\todo{typesetting}

$\infer{\mathit{method}(\overline{a_i}) : \tau_r}{\tau_r \  \mathit{method}(\overline{\tau_i \  p_i}) & \overline{a_i : \tau_i}}$
...
$\infer[\sc{ANY TYPE}]{\vdash : \kappa \  \beta}{\kappa : \mathit{Det / NonDet}}$

%$\infer[COLLECTION TYPE]{\vdash : \kappa \  \beta}{\kappa : OrderNonDet & \beta : Collection/Map/Iterator/array}$

$\infer[\sc{ORDERNONDET \ COLLECTION}]{\vdash : \kappa_c \langle\kappa_e \ \beta_e\rangle \beta_c}{\kappa_c : \mathit{OrderNonDet/Det} & \kappa_e \sqsubseteq \kappa_c & \beta_c \sqsubseteq \mathit{Collection/Map/Iterator}}$

$\infer[\sc{ORDERNONDET \ ARRAY}]{\vdash : \kappa_c [\kappa_e \ \beta_e] \beta_c}{\kappa_c : \mathit{OrderNonDet/Det} & \kappa_e \sqsubseteq \kappa_c }$

$\infer[\sc{NONDET \ COLLECTION}]{\vdash : \kappa_c \langle\kappa_e \ \beta_e\rangle \beta_c}{\kappa_c : \mathit{NonDet} & \kappa_e : \mathit{NonDet} & \beta_c \sqsubseteq \mathit{Collection/Map/Iterator}}$

$\infer[\sc{NONDET \ ARRAY}]{\vdash : \kappa_c [\kappa_e \ \beta_e] \beta_c}{\kappa_c : \mathit{NonDet} & \kappa_e : \mathit{NonDet} }$
