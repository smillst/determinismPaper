...
% any given pair of types has a \textit{least upper bound} and a
% \textit{greatest lower bound}.\todo{It guarantees that any pair of types
%   has an upper and a lower bound, but not that a unique least upper bound
