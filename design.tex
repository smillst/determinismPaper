...
\begin{figure}
    ...
    $\infer[\textsc{invariant type param}]{\|method|(\overline{a_i}) : \tau_r}{\tau_r \  \|method|(\overline{\tau_i \  p_i}) & \overline{a_i : \tau_i}}$
...
\begin{figure}
    ...
    basetypes, type qualifiers, and types.  Most standard rules are omitted
    for brevity.}
    \label{typecheck-rules}
\end{figure}
