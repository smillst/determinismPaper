...
\item
  Nondeterminism reduces users' and developers' \textbf{trust} in a program's output.\todo{If possible, add a citation here to parallel the earlier bullets.}
\end{itemize}
...
programs that do not flip coins.\todo{MK: This statement is very strong,
