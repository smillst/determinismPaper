...
NonDex uses a modified JVM that returns different results on different
...
\begin{enumerate}
  ...
  \item We implemented analysis, as a pluggable type system for Java, in a
  ...
  \item We compared \theDeterminismChecker our tool against state-of-the-art flaky test
